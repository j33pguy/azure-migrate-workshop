...
**Not performed:** Azure provisioning, Windows/Hyper-V execution, marketplace disk first boot, downloaded installer execution, live Az/Azure integration, actual discovery/provider registration, replication, migration, monitored ingestion, backup restore or real resource deletion. No Azure resources or billing settings were changed. At the owner's request, a personal GitHub fork was created at [j33pguy/azure-migrate-workshop](https://github.com/j33pguy/azure-migrate-workshop); this refresh is prepared on `codex/hyperv-workshop-refresh` for draft review there.
